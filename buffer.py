...
actors = [
    ...
    {ID:"N2", color:green, actor_type:"nurse", x:55, y:43, zone:"21"},
    {ID:"N3", color:green, actor_type:"nurse", x:60, y:43, zone:"21"},
    {ID:"N4", color:green, actor_type:"nurse", x:78, y:43, zone:"33"},
    {ID:"N5", color:green, actor_type:"nurse", x:83, y:43, zone:"33"},
    {ID:"N6", color:green, actor_type:"nurse", x:88, y:43, zone:"33"},
    {ID:"N7", color:green, actor_type:"nurse", zone:""}
]
