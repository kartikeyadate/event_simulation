...
class Meet:
    ...
    def remove_participant(self, p, screen):
        pass
...
class Step:
    """
    Defines a step in an event. A step can exist in one of 4 states:
        1. Move
        2. Meet
        3. Move and Meet
        4. Idle
    Defines transitions between states (+- move, +- actor)
    """
    S = dict()
    def __init__(self, actors = list(), zone = None, target = None, progress = 0, duration = random.choice(range(15,40))):
        self.actors = list()
        pass
